...
CKEDITOR.tools.buildTableMap=function(q,r,B,v,w){q=q.$.rows;B=B||0;v="number"===typeof v?v:q.length-1;w="number"===typeof w?w:-1;var u=-1,y=[];for(r=r||0;r<=v;r++){u++;!y[u]&&(y[u]=[]);for(var t=-1,z=B;z<=(-1===w?q[r].cells.length-1:w);z++){var p=q[r].cells[z];if(!p)break;for(t++;y[u][t];)t++;for(var A=isNaN(p.colSpan)?1:p.colSpan,p=isNaN(p.rowSpan)?1:p.rowSpan,x=0;x<p&&!(r+x>v);x++){y[u+x]||(y[u+x]=[]);for(var C=0;C<A;C++)y[u+x][t+C]=q[r].cells[z]}t+=A-1;if(-1!==w&&t>=w)break}}return y};(function(){var g=[CKEDITOR.CTRL+90,CKEDITOR.CTRL+89,CKEDITOR.CTRL+CKEDITOR.SHIFT+90],n={8:1,46:1};CKEDITOR.plugins.add("undo",{init:function(a){function b(a){d.enabled&&!1!==a.data.command.canUndo&&d.save()}function c(){d.enabled=a.readOnly?!1:"wysiwyg"==a.mode;d.onChange()}var d=a.undoManager=new e(a),l=d.editingHandler=new k(d),f=a.addCommand("undo",{exec:function(){d.undo()&&(a.selectionChange(),this.fire("afterUndo"))},startDisabled:!0,canUndo:!1}),h=a.addCommand("redo",{exec:function(){d.redo()&&
...
ga={37:1,38:1,39:1,40:1,8:1,46:1};CKEDITOR.plugins.widget=g;g.repository=p;g.nestedEditable=q})();(function(){CKEDITOR.plugins.add("oembed",{icons:"oembed",hidpi:!0,requires:"widget,dialog",version:"1.18",onLoad:function(){CKEDITOR.document.appendStyleSheet(this.path+"css/oembed.css")},init:function(d){function p(a,e,c,k,f,h,l,b,g){if(""===g)return alert(d.lang.oembed.titleError),!1;jQuery("body").oembed(a,{onEmbed:function(e){var f=jQuery.fn.oembed.getOEmbedProvider(a);b.element.data("resizeType",h);if("responsive"==h||"custom"==h)b.element.data("maxWidth",c),b.element.data("maxHeight",k);""!==
g&&b.element.data("title",g);b.element.data("align",l);"center"==l?(b.inline||b.element.setStyle("text-align","center"),b.element.removeStyle("float")):(b.inline||b.element.removeStyle("text-align"),"none"==l?b.element.removeStyle("float"):b.element.setStyle("float",l));"string"===typeof e.code?(b.element.$.firstChild&&b.element.$.removeChild(b.element.$.firstChild),b.element.appendHtml(e.code),b.element.data("oembed",a),b.element.data("oembed_provider",f.name),b.element.addClass("oembed-provider-"+
f.name)):"string"===typeof e.code[0].outerHTML?(b.element.$.firstChild&&b.element.$.removeChild(b.element.$.firstChild),b.element.appendHtml(e.code[0].outerHTML),b.element.data("oembed",a),b.element.data("oembed_provider",f.name),b.element.addClass("oembed-provider-"+f.name)):alert(d.lang.oembed.noEmbedCode)},onError:function(a){0<a.indexOf("vimeo.com")?alert(d.lang.oembed.noVimeo):alert(d.lang.oembed.Error)},maxHeight:k,maxWidth:c,useResponsiveResize:f,embedMethod:"editor",title:g,expandUrl:!1})}
